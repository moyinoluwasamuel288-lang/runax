...
(function () {
  ...
  let prevChaosPhase = -1;  // detect phase transitions for one-shot audio stings
  // Accumulated glitch offset — randomised each frame during chaos, used by
  // _drawChaosGlitch() to render horizontal scan-tear lines.
  let glitchLines = [];     // [{y, w, dx, alpha}]
