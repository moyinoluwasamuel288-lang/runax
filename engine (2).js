...
const Engine = (() => {
  ...
  /* ── Chaos warning sting (ominous descending tone, 2 s) ── */
  ...
  /* ── Chaos active sting (dissonant impact) ── */
  ...
  /* ── Continuous low-frequency chaos rumble ── */
